function init() {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var bioSample = sampleNames[0];
      buildCharts(bioSample);
      buildMetadata(bioSample);
    });
  }
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var bioSample = filteredSamples[0];
  
      // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
      var otu_ids = bioSample.otu_ids;
      var otu_labels = bioSample.otu_labels;
      var sample_values = bioSample.sample_values;
    ...
    // 5. Create the layout for the gauge chart.
      ...
      var gaugeLayout = { width: 500, height: 450, paper_bgcolor: 'lightgray', plot_bgcolor: 'lightgray'};
